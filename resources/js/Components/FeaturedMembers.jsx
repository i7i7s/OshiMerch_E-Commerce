...
const API_URL = 'https://jkt48-member-api-i7i7.vercel.app';
        ...
        fetch(`${API_URL}/members`)
            ...
            .then(data => {
                ...
                trendingMembers.forEach(m => {
                    ...
                    map[m.name] = match ? proxyPhoto(match.photo || match.image) : null;
                });
                setPhotoMap(map);
            })
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-6 gap-4 sm:gap-6">
                    {trendingMembers.map((member, index) => {
                        ...
                        const photo = photoMap[member.name] || avatarFallback(member.name, teamColor);
                        return (
                            <motion.div
                            ...
                            >
                                <div className="relative mx-auto w-20 h-20 sm:w-24 sm:h-24 mb-3">
                                    ...
                                    <img
                                        ...
                                        onError={e => { e.target.src = avatarFallback(member.name, teamColor); }}
                                    />
                                    <div
                                ...
                                <h3 className="text-sm font-semibold text-surface-800 group-hover:text-primary-600 transition-colors">{member.name}</h3>
