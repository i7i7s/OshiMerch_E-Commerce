        ...
        <>
            ...
            <div className="min-h-screen bg-surface-50 flex flex-col items-center justify-center px-4 py-12">
                ...
                <div className="fixed inset-0 pointer-events-none overflow-hidden">
                    <div className="absolute -top-40 -right-40 w-96 h-96 bg-secondary-200/20 rounded-full blur-3xl animate-float" />
                    <div className="absolute bottom-20 -left-20 w-72 h-72 bg-primary-200/15 rounded-full blur-3xl animate-float" style={{ animationDelay: '3s' }} />
                </div>
                ...
                <div className="relative z-10 w-full max-w-md">
                    <div className="bg-white rounded-2xl border border-surface-200 shadow-card p-8">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-surface-500 text-sm">
                                Bergabung dengan komunitas fans JKT48 di OshiMerch.
                            </p>
                        </div>

                        {/* Google Register Button — Primary CTA */}
                        <a
                        ...
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <span className="text-xs text-surface-400 font-medium">atau daftar dengan email</span>
                            <div className="flex-1 h-px bg-surface-200" />
                        </div>
                        ...
                        <form onSubmit={submit} className="space-y-4">
                            ...
                            <div>
                                <label htmlFor="password_confirmation" className="block text-sm font-medium text-surface-700 mb-1.5">
                                    Konfirmasi Password
                                </label>
                                <input
                    ...
                    <p className="text-center text-sm text-surface-500 mt-6">
                        Sudah punya akun?{' '}
                        <Link href={route('login')} className="text-primary-600 hover:text-primary-700 font-semibold">
                            Masuk di sini
                        </Link>
                    </p>
                </div>
