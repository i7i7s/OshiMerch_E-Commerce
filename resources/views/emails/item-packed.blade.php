...
<title>Pesanan Sedang Dipacking – OshiMerch</title>
</head>
        ...
        <tr>
          <td style="background:#ffffff;padding:40px 40px 32px;">
            ...
            <div style="text-align:center;margin-bottom:28px;">
              ...
              <h1 style="margin:16px 0 8px;font-size:22px;font-weight:700;color:#1F2937;">Pesananmu Sedang Dipacking!</h1>
              <p style="margin:0;font-size:15px;color:#6B7280;">
                Penjual sedang mempersiapkan paketmu dengan penuh kasih sayang ✨
              </p>
            </div>
            ...
            {{-- Tracking --}}
            <div style="background:#EDE9FE;border-radius:12px;padding:20px;margin-bottom:28px;text-align:center;">
              ...
              <p style="margin:0;font-size:24px;font-weight:800;color:#5B21B6;letter-spacing:2px;">{{ $txn->oshigo_tracking_number }}</p>
              <p style="margin:8px 0 0;font-size:13px;color:#8B5CF6;">Simpan nomor ini untuk melacak paketmu</p>
            </div>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td style="text-align:center;width:25%;">
                    ...
                    <p style="margin:6px 0 0;font-size:11px;color:#EC4899;font-weight:600;">Packing</p>
                  </td>
                  <td style="border-top:2px solid #E5E7EB;"></td>
                  <td style="text-align:center;width:25%;">
                    <div style="width:32px;height:32px;border-radius:50%;background:#E5E7EB;line-height:32px;font-size:14px;color:#9CA3AF;margin:0 auto;">🚚</div>
                    <p style="margin:6px 0 0;font-size:11px;color:#9CA3AF;">Dikirim</p>
                  </td>
                </tr>
              </table>
            </div>
