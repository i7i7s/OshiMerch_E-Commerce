...
<title>Pembayaran Dikonfirmasi – OshiMerch</title>
</head>
        ...
        <tr>
          <td style="background:#ffffff;padding:40px 40px 32px;">
            ...
            <div style="text-align:center;margin-bottom:28px;">
              ...
              <h1 style="margin:16px 0 8px;font-size:22px;font-weight:700;color:#1F2937;">Pembayaranmu Dikonfirmasi!</h1>
              <p style="margin:0;font-size:15px;color:#6B7280;">
                Kabar baik! Penjual sudah mengkonfirmasi pembayaranmu untuk item berikut:
              </p>
            </div>
            ...
            @if($txn->oshigo_tracking_number)
            <div style="background:#EDE9FE;border-left:4px solid #7C3AED;border-radius:0 8px 8px 0;padding:16px;margin-bottom:24px;">
              <p style="margin:0;font-size:14px;font-weight:600;color:#5B21B6;">📦 Nomor Tracking OshiGo</p>
              <p style="margin:8px 0 0;font-size:18px;font-weight:800;color:#7C3AED;letter-spacing:1px;">{{ $txn->oshigo_tracking_number }}</p>
            </div>
            @endif

            {{-- Info --}}
            <div style="background:#ECFDF5;border-left:4px solid #10B981;border-radius:0 8px 8px 0;padding:16px;margin-bottom:28px;">
              <p style="margin:0;font-size:14px;color:#065F46;">🎉 Penjual akan segera menyiapkan dan mengirimkan barangmu. Pantau status pengiriman di halaman transaksi.</p>
            </div>
